...
public class MinCoins {
  ...
  static int minimumElementsUtil1(int[] arr, int ind, int T, int[][] dp) {
        ...
        int notTaken = 0 + minimumElementsUtil1(arr, ind - 1, T, dp);
        ...
        if (arr[ind] <= T)
            taken = 1 + minimumElementsUtil1(arr, ind, T - arr[ind], dp);
    ...
    static int minimumElements1(int[] arr, int T) {
        ...
        int ans = minimumElementsUtil1(arr, n - 1, T, dp);
    ...
    //Tabulation
    //TC:O(N*T) SC:O(N*T)
    static int minimumElements2(int[] arr, int T) {
        int n = arr.length;
    ...
    //Space Optimization
    //TC:O(N*T) SC:O(T)
    static int minimumElements3(int[] arr, int T) {
        int n = arr.length;
    ...
    public static void main(String args[]) {
        ...
        System.out.println("The minimum number of coins required to form the target sum is " + minimumElements1(arr, T));
        System.out.println("The minimum number of coins required to form the target sum is " + minimumElements2(arr, T));
        System.out.println("The minimum number of coins required to form the target sum is " + minimumElements3(arr, T));
    }
}
