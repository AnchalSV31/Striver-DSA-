...
public class Knapsack {
  ...
  public static int knapsackUtil(int[] wt, int[] val, int ind, int W, int[][] dp) {
    ...
    //Tabulation
    //TC:O(N*W) SC:O(N*W)
    public static int unboundedKnapsack2(int n, int W, int[] val, int[] wt) {
        // Create a 2D array to store results of subproblems
        int[][] dp = new int[n][W + 1];
    ...
    //Space Optimization
    //TC:O(N*W) SC:O(W)
    public static int unboundedKnapsack3(int n, int W, int[] val, int[] wt) {
